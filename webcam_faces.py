...
if __name__ == '__main__':
 ...
 """
    ...
    for f in files:
        ...
        # Liste des visages
        visages.append(  face_recognition.face_encodings(face_recognition.load_image_file(fic))[0])



    # Create arrays of known face encodings and their names
    Global.known_face_encodings =visages
    #  [obama_face_encoding,biden_face_encoding] 
    Global.known_face_names = noms
